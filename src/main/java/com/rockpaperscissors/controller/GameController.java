...
/**
 * This is the controller in charge of handling all the requests regarding
 ...
 * only handle the requests. For the rest of the operations it will invoke
 * the different methods of the {@link GameService}
 * <p>
 * Per standard, all the requests will return an instance of the record {@link SystemResponse}
 * <p>
...
public class GameController
{
    ...
    /**
     * This request is a post since creating a new game is not
    ...
    {
        return this.executeServiceRequestAndHandleExceptions(() ->
                SystemResponse.generateSuccessResponse(this.gameService.startNewDefaultGame()));
    }

    /**
     * This request will <strong>modify a game</strong> by adding a newly generated round to it.
     * This is not idempotent either, which is why patch is used, since patch requests are not
    ...
    /**
     * Retrieves the information about the current progress of the game.
     ...
     */
    private SystemResponse executeServiceRequestAndHandleExceptions(Callable<SystemResponse> func)
    {
        try
        {
            return func.call();
