...
class StatisticsControllerTest extends ControllerTestGeneric
{
    ...
    StatisticsControllerTest()
    {
        ...
        this.getGameStatistics = MockMvcRequestBuilders.post("/statistics");
    }
    ...
    void getStatistics() throws Exception
    {
        ...
        Assertions.assertEquals(1, Integer.parseInt(statisticsData.get(StatisticsResponseKeys.TOTAL_ROUNDS.getKeyName())), "There should be only one round");
        ...
        Assertions.assertEquals(2, Integer.parseInt(statisticsData.get(StatisticsResponseKeys.TOTAL_ROUNDS.getKeyName())), "There should be only one round");
    ...
    {
        this.createNewRound = MockMvcRequestBuilders.get(String.format("/game/%s/newRound", gameID));
    ...
    private Map<String,String> checkStatisticsIntegrityFromResponse(SystemResponse response)
    {
        ...
        Assertions.assertTrue(responseContent.get(StatisticsResponseKeys.STATISTICS.getKeyName()) instanceof  Map, "The statistics should be a map");

        Map<String,String> statisticsData = (Map<String, String>) responseContent.get(StatisticsResponseKeys.STATISTICS.getKeyName());
